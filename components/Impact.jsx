...
export default function Impact() {
  ...
  return (
    <div className="pt-10 bg-[#faf7f5]">
      <h2 className="px-5 sm:px-[30px] 2xl:mx-[130px] text-sec font-light text-[38px] leading-[56px] mb-[15px] md:mb-[25px]">
        impact
      </h2>
      <div>
        ...
        <div className="lg:md:w-[576px] md:w-[75%]  relative px-[30px] pt-[30px] pb-[60px] md:-translate-y-1/2 bg-white shadow-small mx-auto">
      ...
      <div>
        <div className="bg-white ">
          <div className="py-[60px] px-5 flex flex-col gap-5 2xl:mx-[130px]">
            {data.map((el, i) => {
              return (
                <div
                  key={i}
                  className="py-[25px] shadow-small gap-5 flex flex-col bg-white px-[30px]"
                >
                  <h3 className="text-2xl font-light text-[#008053]">
                    {el.title}
                  </h3>
